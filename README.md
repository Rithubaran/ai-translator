...
- **🤖 AI-Powered Translation**: Uses OpenAI's GPT-3.5-turbo for accurate translations
- **🌍 100+ Languages**: Support for languages from around the world with country flags
- **🎨 Beautiful Animations**: Floating stars, gradient text effects, and smooth transitions
- **📝 Text Formatting**: Bold, italic, underline, font size, and color customization
- **🎨 Modern UI**: Glassmorphism design with dark theme and gold accents
- **📱 Responsive Design**: Works perfectly on desktop, tablet, and mobile devices
- **⚡ Real-time Character Count**: Track your text length as you type
